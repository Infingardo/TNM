...
R += [
  ...
  # Gh salivari
  ("'AJCC Version 9 / UICC 9ª ed.: classificazione N radicalmente rivista. pN3 ELIMINATO. N ora basato su numero LN e pENE (non dimensione o lateralità). Downgrading complessivo: casi precedentemente IVA/IVB per N2/N3 dimensionale ora classificati come Stadio III. Stadio IV riservato esclusivamente a M1.'",
   "'AJCC Version 9 / UICC 9th ed.: N classification radically revised. pN3 ELIMINATED. N now based on LN number and pENE (not size or laterality). Overall downgrading: previously IVA/IVB cases by dimensional N2/N3 now classified as Stage III. Stage IV exclusively reserved for M1.'"),
  # Melanoma
  ("'AJCC Cancer Staging Manual, Version 9: aggiunge suffisso LDH alle sottocategorie M — M1a(0)/M1a(1), M1b(0)/M1b(1), M1c(0)/M1c(1), M1d(0)/M1d(1) — dove (0)=LDH normale, (1)=LDH elevata. UICC 9ª ed. non adotta formalmente il suffisso LDH. Staging T/N/M e Stage Groups: identici.'",
   "'AJCC Cancer Staging Manual, Version 9: adds LDH suffix to M subcategories — M1a(0)/M1a(1), M1b(0)/M1b(1), M1c(0)/M1c(1), M1d(0)/M1d(1) — where (0)=normal LDH, (1)=elevated LDH. UICC 9th ed. does not formally adopt the LDH suffix. T/N/M staging and Stage Groups: identical.'"),
...
R += [
  ...
  ('Stadio anatomico UICC + Prognostic Stage Group AJCC v9', 'UICC 9th ed. anatomic stage + AJCC 8th ed. Prognostic Stage Group'),
